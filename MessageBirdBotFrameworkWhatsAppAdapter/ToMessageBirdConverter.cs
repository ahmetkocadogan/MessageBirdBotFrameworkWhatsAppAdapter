...
using MessageBirdBotFrameworkWhatsAppAdapter.Models;
...
namespace MessageBirdBotFrameworkWhatsAppAdapter
{
    public class ToMessageBirdConverter
    {
        public static List<MessageBirdSendMessagePayload> Convert(Activity activity)
        {
            ...
            //message.conversationId = activity.Conversation.Id;
            //message.conversationMessageRequest = new ConversationMessageSendRequest();
            //message.conversationMessageRequest.ChannelId = activity.ChannelId.Split('-')[1];//activity.GetChannelData<MessageBirdWebhookPayload>().message.channelId;
            //message.conversationMessageRequest.Content = new Content() { Text = activity.Text };
            //message.conversationMessageRequest.ConversationId = activity.Conversation.Id;
